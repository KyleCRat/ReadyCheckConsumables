...
RCC.db.wenchants = {
    ...
    [8056] = { ench = 8056, item = 243738, icon = 7548986, q = 2 }, -- Smuggler's Enchanted Edge
    [8055] = { ench = 8055, item = 243737, icon = 7548986, q = 1 }, -- Smuggler's Enchanted Edge
    [8054] = { ench = 8054, item = 243736, icon = 7548985, q = 2 }, -- Oil of Dawn
    [8053] = { ench = 8053, item = 243735, icon = 7548985, q = 1 }, -- Oil of Dawn
    [8052] = { ench = 8052, item = 243734, icon = 7548987, q = 2 }, -- Thalassian Phoenix Oil
    [8051] = { ench = 8051, item = 243733, icon = 7548987, q = 1 }, -- Thalassian Phoenix Oil

    -- 12.0.0 - Midnight: Weightstone
    [7908] = { ench = 7908, item = 237369, icon = 7548939, q = 2 }, -- Refulgent Weightstone
    [7907] = { ench = 7907, item = 237367, icon = 7548938, q = 1 }, -- Refulgent Weightstone

    -- 12.0.0 - Midnight: Whetstone
    [7905] = { ench = 7905, item = 237371, icon = 7548942, q = 2 }, -- Refulgent Whetstone
    [7904] = { ench = 7904, item = 237370, icon = 7548941, q = 1 }, -- Refulgent Whetstone
