...
local MACRO_DEFINITIONS = {
    {
        ...
        label = "Food",
        macroName = "RCC Food",
        description = "Uses the cached food item when selected, otherwise the best available food.",
    ...
    },
    {
        ...
        label = "Flask",
        macroName = "RCC Flask",
        description = "Uses the cached flask when selected, otherwise the best available flask.",
    ...
    },
    {
        ...
        description = "Uses the cached augment rune when selected, otherwise the preferred available augment rune.",
    ...
    },
    {
        ...
        description = "Uses the cached Vantus rune for the current raid, otherwise the best available current-raid rune.",
