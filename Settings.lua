...
local DEFAULTS = {
    ...
    icon_lethalPoison        = true,
    icon_nonLethalPoison     = true,
    ...
    consumablesActionBar_icon_lethalPoison = true,
    consumablesActionBar_icon_nonLethalPoison = true,
...
local function createMacrosSettingsFrame(measurementFrame)
    ...
    local bodyText = "RCC macros keep action-bar buttons linked to your preferred "
        .. "consumables. Right-click a regular item on either personal display "
        .. "or its flyout to save that exact item and rank. Buttons retain "
        .. "your choice when it runs out; macros can use available fallbacks "
        .. "without changing it. Matching-family fleeting items take priority "
        .. "while carried, but cannot be saved as preferences. Without a "
        .. "preference, RCC chooses automatically. Item macros other than "
        .. "Augment Rune include one eligible backup from your bags, ready if "
        .. "the primary runs out during combat. Augment Rune macros use only "
        .. "the selected rune, with no backup.\n\n"
